...
const Player: React.FC<PlayerType> = ({
	...
	return (
		<div
			...
			{/* name */}
			<p className="absolute -top-1 -translate-y-full left-1/2 font-bold -translate-x-1/2 bg-gray-800/50 text-white px-2 py-0.1 rounded-lg whitespace-nowrap capitalize">
				{name}
			</p>
		</div>
	);
