  ...
  return (
    <div
      className={classNames(
        "relative h-[calc(100vh-3.7rem)] duration-500 bg-[#28324E] border-l-[1px] border-indigo-200/20 flex flex-col",
...
const Message: React.FC<MessageType> = ({ message, created_date, sent_by }) => {
  return (
    <div className="flex gap-3 mt-3">
      <div className="min-w-[1.5rem] h-6 bg-white rounded-full"></div>
